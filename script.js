document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('required') || field.dataset.required === 'true') {
        if (!validators.required(field.type === 'checkbox' ? value : value)) {
          isValid = false;
      ...
      if (isValid && field.dataset.minlength && value.trim() !== '') {
      ...
      if (isValid && field.dataset.validate === 'phone' && value.trim() !== '') {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      const successMessage = contactForm.querySelector('.form-success, [data-form-success]');
      const errorMessage = contactForm.querySelector('.form-error, [data-form-error]');
  ...
  const animatableElements = document.querySelectorAll(
    '[data-animate], .animate-on-scroll, [data-scroll-animation]'
  );
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "וילה דניאל עם בריכה בחד - נס משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '36310cba-f81a-4cfe-a611-33b517b71133',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '36310cba-f81a-4cfe-a611-33b517b71133';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '36310cba-f81a-4cfe-a611-33b517b71133';
